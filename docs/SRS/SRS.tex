...
\textbf{Description:}  The system must allow users to input song queries via text or upload audio files \\
\textbf{Rationale:} Provides the primary interface for user interaction \\
\textbf{Originator:} Requirement Analyst \\
\textbf{Fit Criterion:} The GUI should display input fields for text and file upload \\
\textbf{Customer Satisfaction:} 5 \\
\textbf{Customer Dissatisfaction:} 0 \\
\textbf{Priority:} High \\
\textbf{Conflicts:} None \\
\textbf{Supporting Material:} None \\
\textbf{History:} Created January 18, 2025
\end{minipage}
}
...
\textbf{Requirement Type:} 9 \\
\textbf{Event/Use Case \#:} (need to figure this out later)\\
\textbf{Description:} The system GUI must display search results, including song title, artist, and album cover \\
\textbf{Rationale:} Enables users to identify the desired track. \\
\textbf{Originator:} Requirement Analyst \\
\textbf{Fit Criterion:} Results should be displayed within 10 seconds after a query is submitted \\
\textbf{Customer Satisfaction:} 5 \\
\textbf{Customer Dissatisfaction:} 0 \\
\textbf{Priority:} High \\
\textbf{Conflicts:} None \\
...
\textbf{Requirement Type:} 9 \\
\textbf{Event/Use Case \#:} (need to figure this out later)\\
\textbf{Description:} The system must allow users to play a 30-second preview of each search result \\
\textbf{Rationale:} Helps users confirm their song selection \\
\textbf{Originator:} Requirement Analyst \\
\textbf{Fit Criterion:} Clicking the "Preview" button should play the audio clip \\
\textbf{Customer Satisfaction:} 5 \\
\textbf{Customer Dissatisfaction:} 0 \\
\textbf{Priority:} High \\
\textbf{Conflicts:} None \\
...
\textbf{Requirement Type:} 9 \\
\textbf{Event/Use Case \#:} (need to figure this out later)\\
\textbf{Description:} The system must validate uploaded audio files to ensure they are in supported formats \\
\textbf{Rationale:} Prevents processing errors from unsupported files \\
\textbf{Originator:} Requirement Analyst \\
\textbf{Fit Criterion:} The system should reject unsupported formats with an error message \\
\textbf{Customer Satisfaction:} 5 \\
\textbf{Customer Dissatisfaction:} 0 \\
\textbf{Priority:} High \\
\textbf{Conflicts:} None \\
...
\textbf{Requirement Type:} 9 \\
\textbf{Event/Use Case \#:} (need to figure this out later)\\
\textbf{Description:} The system must convert non-WAV files to WAV format before processing \\
\textbf{Rationale:} Standardizes inputs \\
\textbf{Originator:} Requirement Analyst \\
\textbf{Fit Criterion:} An uploaded file should be converted to WAV \\
\textbf{Customer Satisfaction:} 5 \\
\textbf{Customer Dissatisfaction:} 0 \\
\textbf{Priority:} High \\
\textbf{Conflicts:} None \\
...
\textbf{Requirement Type:} 9 \\
\textbf{Event/Use Case \#:} (need to figure this out later)\\
\textbf{Description:} The system must construct a Spotify query based on user input and retrieve a list of matching songs \\
\textbf{Rationale:} Enables the discovery of songs via text based search \\
\textbf{Originator:} Requirement Analyst \\
\textbf{Fit Criterion:} A query string should be generated and sent to the Spotify API \\
\textbf{Customer Satisfaction:} 5 \\
\textbf{Customer Dissatisfaction:} 0 \\
\textbf{Priority:} High \\
\textbf{Conflicts:} None \\
...
\textbf{Requirement Type:} 9 \\
\textbf{Event/Use Case \#:} (need to figure this out later)\\
\textbf{Description:} The system must extract features \\
\textbf{Rationale:} Provides the necessary data for recommendations \\
\textbf{Originator:} Requirement Analyst \\
\textbf{Fit Criterion:} The extracted features should match ground truth with an accuracy of at least 90\% \\
\textbf{Customer Satisfaction:} 5 \\
\textbf{Customer Dissatisfaction:} 0 \\
\textbf{Priority:} High \\
\textbf{Conflicts:} None \\
...
\textbf{Requirement Type:} 9 \\
\textbf{Event/Use Case \#:} (need to figure this out later)\\
\textbf{Description:} The system must support feature extraction for all 8 features listed in the project scope \\
\textbf{Rationale:} Ensures compatibility with all defined use cases. \\
\textbf{Originator:} Requirement Analyst \\
\textbf{Fit Criterion:} Each feature module must output valid data for a supported audio file \\
\textbf{Customer Satisfaction:} 5 \\
\textbf{Customer Dissatisfaction:} 0 \\
\textbf{Priority:} High \\
\textbf{Conflicts:} None \\
...
\textbf{Requirement Type:} 9 \\
\textbf{Event/Use Case \#:} (need to figure this out later)\\
\textbf{Description:} The system must generate song recommendations based on extracted features \\
\textbf{Rationale:} Helps users discover new songs aligned with their input \\
\textbf{Originator:} Requirement Analyst \\
\textbf{Fit Criterion:} Recommendations should be displayed \\
\textbf{Customer Satisfaction:} 5 \\
\textbf{Customer Dissatisfaction:} 0 \\
\textbf{Priority:} High \\
\textbf{Conflicts:} None \\
...
\textbf{Requirement Type:} 9 \\
\textbf{Event/Use Case \#:} (need to figure this out later)\\
\textbf{Description:} The system must transmit user-selected inputs (text queries or audio files) to the server for processing \\
\textbf{Rationale:} Facilitates communication between the client and server \\
\textbf{Originator:} Requirement Analyst \\
\textbf{Fit Criterion:} Data packets should reach the server without loss or corruption \\
\textbf{Customer Satisfaction:} 5 \\
\textbf{Customer Dissatisfaction:} 0 \\
\textbf{Priority:} High \\
\textbf{Conflicts:} None \\
...
\textbf{Requirement Type:} 9 \\
\textbf{Event/Use Case \#:} (need to figure this out later)\\
\textbf{Description:} The system must receive processed results (recommendations) from the server \\
\textbf{Rationale:} Displays processed information to the user \\
\textbf{Originator:} Requirement Analyst \\
\textbf{Fit Criterion:} GUI updates with the processed results (recommendations) \\
\textbf{Customer Satisfaction:} 5 \\
\textbf{Customer Dissatisfaction:} 0 \\
\textbf{Priority:} High \\
\textbf{Conflicts:} None \\
