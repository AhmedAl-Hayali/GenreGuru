...
\begin{enumerate}
  ...
  \item The generative system be able to generate songs from less popular music genres (jazz, blues, etc.)
  ...
  \item The generative system be able to generate songs from less popular music genres (gnawa, libyan funk, etc.)
  \item The recommendation system will be able to search for songs with cover art similar to the input songs
  \item The generative system will be able to generate new cover art for a newly generated song
