...
\begin{itemize}
  ...
  generated snippet. For example, the EULA might need to state whether the generated snippet can be used commercially or not. The implication 
  of this means that a creative professional's ability to actually use this portion of the service could be greatly limited depending on what tracks they
