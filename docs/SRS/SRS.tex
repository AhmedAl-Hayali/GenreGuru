...
\textbf{Description:} The system should feature a client application for user interaction and input. \\
...
\textbf{Fit Criterion:} The client application handles user inputs and sends requests to the compute server. \\
...
\textbf{Description:} The system will generate song recommendations based on the user's input. \\
...
\textbf{Description:} The system will analyze a reference song or snippet, and display its features. \\
...
\textbf{Description:} The system will validate user inputs to ensure they are correct, eg of the right format (reference to song, not audio file). \\
...
\textbf{Requirement Type:} 9 \\
\textbf{Event/Use Case \#:} 1 \\
\textbf{Description:} The client application should display the output of other system components \\
...
\textbf{Conflicts:} None \\
\textbf{Supporting Material:} None \\
\textbf{History:} Created October 30, 2024
\end{minipage}
}

\vspace{20pt}

These are going to be the newly defined ones
...
\textbf{Description:} The client application should allow user to provide a reference link to a song to initiate a request from the system \\
...
\textbf{Requirement Type:} 9 \\
\textbf{Event/Use Case \#:} (need to figure this out later)\\
\textbf{Description:} The system should display the extracted features of an analyzed reference song in a clear, interpretable format. \\
\textbf{Rationale:} Users need a clear breakdown of song features, presented in a way that helps them understand and interpret the results \\
\textbf{Originator:} Requirement Analyst \\
\textbf{Fit Criterion:} After feature extraction, the system provides a textual and /or visual representation of the results \\
\textbf{Customer Satisfaction:} 5 \\
\textbf{Customer Dissatisfaction:} 0 \\
\textbf{Priority:} High \\
\textbf{Conflicts:} None \\
