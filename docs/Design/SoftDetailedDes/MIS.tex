...
& \textbf{Spotify URL Input Module}\\
...
\begin{itemize}
  ...
  \item Screen Display
  \item Keyboard (physical or digital) for text input
\end{itemize}
...
%subinput 2
\section{MIS of Spotify URL Input Module} 

\subsection{Spotify URL Input Module}
User inputs a spotify URL and a reference is generated through the input. 
...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions}\\
\hline%by results, at this stage, we mean the output of the final program (could include features, includes recs)
On Input Button Press &Spotify URL Song &Song reference &Invalid Spotify URL\\
...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions}\\
\hline%by results, at this stage, we mean the output of the final program (could include features, includes recs)
On Input Button Press &Audio File &Song reference &Invalid File Type\\
