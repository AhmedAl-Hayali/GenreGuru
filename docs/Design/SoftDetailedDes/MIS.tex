...
\subsubsection{Exported Constants}
MAX\textunderscore TEMPO: A value $\mathbb{R}$ representing the maximum allowed tempo for a song. 
...
\item exception: \texttt{RangeError}: Output Tempo Value is out of range [0, MAX\textunderscore TEMPO]
\end{itemize}
