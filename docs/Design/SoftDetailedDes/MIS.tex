...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions}\\
\hline
Generate Recommendations &Song\textunderscore Features \texttt{np.ndarray[Features]} &Rec\textunderscore Tracks \linebreak\texttt{np.ndarray[Tracks]} &N/A\\
\hline
\end{tabular}
\end{center}
...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions}\\
\hline
Generate Spotify Embed &Rec\textunderscore Tracks \linebreak\texttt{np.ndarray[Tracks]} &Tracks\textunderscore Embed &N/A\\
\hline
\end{tabular}
\end{center}
