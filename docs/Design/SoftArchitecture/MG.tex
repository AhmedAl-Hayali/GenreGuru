...
\subsubsection{Master User Interface Input Module (\mref{m1})}
...
%input method 1
\subsubsection{First-Match Text Field Input Module (\mref{m2})}

\begin{description}
\item[Secrets:]The format and structure of the input data.
\item[Services:] Takes in multiple song requests from the user. 
\item[Implemented By:] [Your Program Name Here]
\item[Type of Module:] [Record, Library, Abstract Object, or Abstract Data Type]
  [Information to include for leaf modules in the decomposition by secrets tree.]
\end{description}
...
%input method 2
\subsubsection{URL Input Module (\mref{m2})}

\begin{description}
\item[Secrets:] The format and structure of the input data.
\item[Services:] Takes in URL input from User
\item[Implemented By:] [Your Program Name Here]
\item[Type of Module:] [Record, Library, Abstract Object, or Abstract Data Type]
  [Information to include for leaf modules in the decomposition by secrets tree.]
\end{description}
...
%input method 3
\subsubsection{Audio File Input Module (\mref{m2})}
...
%input method 4
\subsubsection{Spotify Query Search \& Select (\mref{m2})}
...
%featurizers
%f1
\subsubsection{Tempo (BPM) Feature Extraction Module (\mref{m2})}
...
%f2
\subsubsection{Key and Scale Feature Extraction Module (\mref{m2})}
...
%f3
\subsubsection{Instrument Type Feature Extraction Module (\mref{m2})}
...
%f4
\subsubsection{Vocal Gender Feature Extraction Module (\mref{m2})}
...
%f5
\subsubsection{Dynamic Range Feature Extraction Module (\mref{m2})}
...
%f6
\subsubsection{Instrumentalness Feature Extraction Module (\mref{m2})}
...
%f7
\subsubsection{Contour Feature Extraction Module (\mref{m2})}
...
%f8
\subsubsection{Mood Feature Extraction Module (\mref{m2})}
...
%recommendation
\subsubsection{Recommendation Module (\mref{m2})}
...
%results GUI
\subsubsection{Program Results Interface Module (\mref{m2})}

\begin{description}
\item[Secrets:]The format and structure of the input data.
\item[Services:]Displays program results (recommended songs, features for requested songs? )
\item[Implemented By:] [Your Program Name Here]
\item[Type of Module:] [Record, Library, Abstract Object, or Abstract Data Type]
  [Information to include for leaf modules in the decomposition by secrets tree.]
\end{description}
...
\subsubsection{Database (\mref{m2})}

\begin{description}
\item[Secrets:]The format and structure of the input data.
\item[Services:]Provides storage for generated features for pseudo-caching ?
\item[Implemented By:] Database Service Name
\item[Type of Module:] [Record, Library, Abstract Object, or Abstract Data Type]
  [Information to include for leaf modules in the decomposition by secrets tree.]
\end{description}
...
\subsubsection{Spotify API (\mref{m2})}
...
\subsubsection{Deezer API (\mref{m2})}
...
\subsubsection{Genre Fetcher (\mref{m2})}

\begin{description}
\item[Secrets:]Genre label for a song
\item[Services:]Fetches a genre label for a required song
\item[Implemented By:] Undecided
\item[Type of Module:] Undecided (Deezer API call? User Self-label?)
\end{description}
