...
%input method 2
\subsubsection{Search Query Module (\mref{m2})}
...
%client-server comms
\subsubsection{Client Communication Module (\mref{m2})}
...
\subsubsection{Server Communication Module (\mref{m2})}
...
\subsubsection{Driver Module (\mref{m2})}
...
\subsubsection{Database Module (\mref{m2})}
...
\subsubsection{Genre Feature Module (\mref{m2})}
