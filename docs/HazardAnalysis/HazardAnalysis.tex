...
\begin{itemize}
    \item It is assumed that the user will not attempt to exploit system vulnerabilities to gain unauthorized access to the components of the system.
    \item It is assumed that users will have the physical capabilities to interact with the system.
    \item It is assumed that all libraries used in development are validated and tested.
\end{itemize}
