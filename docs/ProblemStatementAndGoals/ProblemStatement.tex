...
\begin{table}[h!]
    ...
    \begin{tabular}{p{0.45\textwidth} || p{0.45\textwidth}}
        ...
        \midrule
        The recommendation system shall produce a collection of songs that are similar to a single reference song provided or a collecetion of reference songs provided by the user. & This is a core feature of the system. Its inclusion should facilitate users to explore a music genre or ``sound'' of interest. \\
        \midrule
