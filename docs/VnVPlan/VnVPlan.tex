...
\wss{Say what software is being tested.  Give its name and a brief overview of
  ...
  \emph{Verification} --  ensures that we are building the product correctly according to the defined requirements and specifications. This involves:
  \begin{itemize}
  ...
  \emph{Validation} -- Ensure that the project meets the needs of the customer and/or stakeholders within the intended environment, typically through acceptance testing. This process is often performed by individuals external to the project team. \textcolor{red}{``Design validation is similar to verification, except this time you should check the designed product under conditions of actual use.'' (ISO 9001:2015)}
