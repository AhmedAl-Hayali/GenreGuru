...
\begin{itemize}
    ...
    \item \href{URL}{\textbf{Test Plan (TP)}}: The TP outlines the overall testing strategy, methodologies, and test case responsibilities. It complements the VnV plan by providing specific instructions for executing and managing the tests, ensuring that testing aligns with project goals and requirements as defined in the SRS and MG.
