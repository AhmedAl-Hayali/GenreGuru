...
\begin{itemize}
  ...
  \item github actions
\end{itemize}
Our code coverage tools of choice are tox and jest for python and javascript, respectively.
These tools are really nice as not only can they run unit tests, but they also report the
code coverage back to the developers. 
