...
\\ \\
\textbf{\large Client Application} \\
...
\textbf{Roles:}
\begin{itemize}
    \item Ansel Chen: Joint responsibility for client application testing.
    \item Mohamad-Hassan Bahsoun: Joint responsibility for client application testing.
\end{itemize}

\textbf{Checklist:}
\begin{itemize}
  \item[$\square$] User can input track information without errors.
  \item[$\square$] System output is clear and comprehensible.
  \item[$\square$] User feedback is collected and assessed.
\end{itemize}

\vspace{1cm}

\noindent \textbf{\large Server Networking} \\
Represents communication between the server and external components (client application, APIs).
...
\textbf{Roles:}
\begin{itemize}
    \item Ahmed Al-Hayali: Server networking interface testing.
\end{itemize}

\textbf{Checklist:}
\begin{itemize}
  \item[$\square$] All intended connections are established.
  \item[$\square$] Data loss during transmission is within acceptable limits.
  \item[$\square$] Network security measures are implemented and verified.
\end{itemize}

\vspace{1cm}

\noindent \textbf{\large Server Compute} \\
Component responsible for processing requests and issuing featurization.
...
\textbf{Roles:}
\begin{itemize}
    \item Matthew Baleanu: Unit testing for compute.
\end{itemize}

\textbf{Checklist:}
\begin{itemize}
  \item[$\square$] Processing time is optimized for expected load.
  \item[$\square$] Code is clean and adheres to project standards.
  \item[$\square$] Edge cases are handled appropriately.
\end{itemize}

\vspace{1cm}

\noindent \textbf{\large Server Storage} \\
...
\textbf{Roles:}
\begin{itemize}
    \item Ahmed Al-Hayali: Functional testing for server storage.
\end{itemize}

\textbf{Checklist:}
\begin{itemize}
  \item[$\square$] Schema supports all required data types and relationships.
  \item[$\square$] Data retrieval times meet performance criteria.
  \item[$\square$] Data integrity is maintained during transactions.
\end{itemize}

\vspace{1cm}

\noindent \textbf{\large External Service APIs} \\
...
\textbf{Roles:}
\begin{itemize}
    \item Mohamad-Hassan Bahsoun: External service API interface testing.
\end{itemize}

\textbf{Checklist:}
\begin{itemize}
  \item[$\square$] All API endpoints are functional as expected.
  \item[$\square$] Data exchanged is accurate and formatted correctly.
  \item[$\square$] Error handling for API failures is in place.
\end{itemize}

\vspace{1cm}

\noindent \textbf{\large Featurizer} \\
...
\textbf{Roles:}
\begin{itemize}
    \item Ansel Chen: Joint featurizer algorithm testing.
    \item Muhammad Jawad: Joint featurizer algorithm testing.
    \item Mohamad-Hassan Bahsoun: Joint featurizer algorithm testing.
    \item Matthew Baleanu: Joint featurizer algorithm testing.
    \item Ahmed Al-Hayali: Joint featurizer algorithm testing.
\end{itemize}

\textbf{Checklist:}
\begin{itemize}
  \item[$\square$] All features are correctly extracted from input data.
  \item[$\square$] Featurization time is within acceptable limits.
  \item[$\square$] Results match expected outputs for test cases.
\end{itemize}
