...
\begin{description}[leftmargin=0cm]
  ...
  \item[Extras] As stated in the probelm statement document, the team plans to include user \& API documentation for reference. Note that the generation component is now a stretch goal instead of a core feature, as discussed in the hazard analysis document.
\end{description}
