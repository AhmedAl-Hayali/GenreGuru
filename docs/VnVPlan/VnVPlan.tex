...
\begin{description}[leftmargin=0cm]
  ...
  \end{itemize}
  \item[Validation] Ensureing the project meets needs of the stakeholders within the intended environment, typically through acceptance testing. This process is often performed by individuals external to the project team.
\end{description}
