...
\begin{description}[style=unboxed,leftmargin=0cm]
  \item[Linting] Linters like \href{https://pylint.readthedocs.io/}{\texttt{Pylint}}, \href{https://docs.astral.sh/ruff/}{\texttt{Ruff}}, or or \href{https://flake8.pycqa.org/en/stable/}{\texttt{Flake8}} check for errors, enforce a coding standard, identify \href{https://refactoring.guru/refactoring/smells}{code smells}, and can make code refactoring suggestions.
  ...
  \item[Code Walkthroughs] walkthroughs of the algorithms of the featurization component with the supervisor and other teammates. Code walkthroughs will be performed with a checklist.
\end{description}
\begin{itemize}
