...
As stated in the Problem Statement document, the challenge level of this project is general. In light of the revised scope of the project as 
described in hazard analysis document, we have not changed the challenge level of our project. In retrospect, perhaps it was likely the case that 
our project should have been labelled as a challenging project instead. 

In terms of the extras of the project, we had previously stated in the probelm statement document that we would include user & API documentation 
for reference. These are still our current goals. We also now have changed the generation component of the project to a stretch goal instead. 
