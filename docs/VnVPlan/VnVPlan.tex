...
\begin{itemize}
  ...
  \item \emph{Ahmed Al-Hayali}: Functional testing for server storage; server networking interface testing; joint featurizer algorithm testing
  \item \emph{Supervisor/MVM}: Featurizer algorithms validation + select verification runthroughs.
  \item \emph{Stakeholder k}: Validate?
\end{itemize}
